...
def test_pw_new_xml_6_3(fixture_database, fixture_computer_localhost, generate_calc_job_node, generate_parser, generate_inputs):
    
    # TODO: this is just to try out the pytest infrastructure.
    # TODO: fix the assertions below.
    # NOTE: the test data are taken from a Ge2 calculation on "aiidatests" machine
    #       (calc node: 'abe2437a-fb2e-4a4f-b288-eed837559db5', retrieved node: '6842af91-cd21-4073-beba-1587c8eccd12')
    return # TODO: remove
    ...
    node = generate_calc_job_node(entry_point_calc_job, fixture_computer_localhost, 'new_xml_6_3', input_nodes)
